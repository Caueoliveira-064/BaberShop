...
import { Check, X, BellOff, ArrowRight } from 'lucide-react';
import api from '../api';
  ...
  return (
    <div className="modal-overlay">
      <div className="modal-content" style={{ padding: '3rem', textAlign: 'center', background: 'var(--bg-card)', border: '1px solid var(--primary)', animation: 'fadeIn 0.4s ease' }}>
        ...
        <h2 style={{ color: 'var(--text-main)', marginBottom: '10px' }}>Agendamento Confirmado!</h2>
        <p style={{ color: 'var(--text-muted)' }}>Você receberá os detalhes em breve.</p>
        <style>{`
...
const Scheduling = () => {
  ...
  const handleConfirm = async () => {
    ...
    if (!token) {
      alert('Você precisa estar logado para confirmar um agendamento. Vamos redirecionar você para a tela de Login!');
      navigate('/login');
      return;
    }
        ...
        {selectedService && (
          <div style={{ flex: '1 1 350px', maxWidth: '450px' }}>
            <div className="summary-card-highlight fade-in" style={{ position: 'sticky', top: '100px' }}>
              <h3 className="premium-font" style={{ fontSize: '1.5rem', marginBottom: '2rem', textAlign: 'center' }}>Resumo</h3>
              ...
              <div className="summary-total">
                ...
                <span className="summary-total-value">R$ {selectedService.price}</span>
              </div>
